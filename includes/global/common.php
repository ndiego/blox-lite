...
class Blox_Common {
    	...
    	$genesis_hooks = array(
			...
			'loop' => array(
				...
				'hooks' => array(
					...
					// HTML5 Hooks
					'genesis_before_entry' => array( 'name'  => 'genesis_before_entry (HTML5)', 'title' => __( 'This hook executes before each entry in all loop blocks (outside the post_class() container).', 'blox' ) ),
					'genesis_after_entry' => array( 'name'  => 'genesis_after_entry (HTML5)', 'title' => __( 'This hook executes after each entry in all loop blocks (outside the post_class() container).', 'blox' ) ),
					'genesis_entry_header' => array( 'name'  => 'genesis_entry_header (HTML5)', 'title' => __( 'This hook executes before the entry content and generates the entry header content in all loop blocks.', 'blox' ) ),
					'genesis_before_entry_content' => array( 'name'  => 'genesis_before_entry_content (HTML5)', 'title' => __( 'This hook executes before the .entry-content container in all loop blocks.', 'blox' ) ),
					'genesis_entry_content' => array( 'name'  => 'genesis_entry_content (HTML5)', 'title' => __( 'This hook executes within the .entry-content container in all loop blocks.', 'blox' ) ),
					'genesis_after_entry_content' => array( 'name'  => 'genesis_after_entry_content (HTML5)', 'title' => __( 'This hook executes after the .entry-content container in all loop blocks.', 'blox' ) ),
					'genesis_entry_footer' => array( 'name'  => 'genesis_entry_footer (HTML5)', 'title' => __( 'This hook executes after the entry content and generates the entry footer content in all loop blocks.', 'blox' ) ),
					// XHTML Hooks
    ...
    /**
     * Helper function for retrieving all active extensions.
     *
     * @since 1.0.0
     *
     * @return array Array of all active extensions.
     */
    public function get_active_extensions() {

    	$extensions = array();

    	return apply_filters( 'blox_active_extensions', $extensions );
    }
