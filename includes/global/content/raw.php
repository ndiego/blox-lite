...
class Blox_Content_Raw {
	...
	/* Enabled the "raw" content option in the plugin
     *
     * @since 1.0.0
     *
		...
		<table class="form-table blox-content-raw blox-hidden">
			<tbody>
				...
				<tr>
					...
					<td>
						<textarea class="blox-code-textbox" name="<?php echo $name_prefix; ?>[raw][content]" rows="6" ><?php echo ! empty( $get_prefix['raw']['content'] ) ? esc_html( $get_prefix['raw']['content'] ) : ''; ?></textarea>
