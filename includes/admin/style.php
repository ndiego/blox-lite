			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<div class="blox-description">
							<?php echo __( 'All custom CSS for this block should begin with ', 'blox' ) . '<code>#blox_' . $block_scope . '_' . $id . '</code>. ' . sprintf( __( 'Otherwise the custom CSS could interfere with other content blocks. For reference on content block frontend markup, please refer to the %1$sBlox Documentation%2$s.', 'blox' ), '<a href="?utm_source=blox-lite&utm_medium=plugin&utm_content=style-tab-links&utm_campaign=Blox_Plugin_Links" title="' . __( 'Blox Documentation', 'blox' ) . '" target="_blank"target="_blank">', '</a>' ); ?>
						</div>
					</td>
				</tr>
